...
const projects = [
  {
    ...
    description: ' Un ejemplo de una tienda en línea, con un diseño minimalista y moderno, con un diseño responsivo para dispositivos móviles y de escritorio. Se utilizó NextJS, Shopify, NodeJS y TypesCript para su creación.',
  ...
  },
  {
    id: 7,
    title: 'Enespera',
    description: 'una aplicacion web para recerbas y compre de propiedades inmuebles. Se utilizó React, Redux, CSS y JavaScript para su creación.',
