...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://backend-portfolio-production-c573.up.railway.app/externed/contact", formData);
...
// "https://backend-portfolio-production-c573.up.railway.app/"